...
import { db, toolMetadata } from '@letta-cloud/service-database';
import { and, count, eq, ilike, or, sql } from 'drizzle-orm';

type ListToolMetadataRequest = ServerInferRequest<
  typeof contracts.toolMetadata.listToolMetadata
>;
type ListToolMetadataResponse = ServerInferResponses<
  typeof contracts.toolMetadata.listToolMetadata
>;
...
type GetToolMetadataSummaryResponse = ServerInferResponses<
  typeof contracts.toolMetadata.getToolMetadataSummary
>;
...
type ListToolGroupsRequest = ServerInferRequest<
  typeof contracts.toolMetadata.listToolGroupMetadata
>;
type ListToolGroupsResponse = ServerInferResponses<
  typeof contracts.toolMetadata.listToolGroupMetadata
>;
...
type GetSingleToolMetadataRequest = ServerInferRequest<
  typeof contracts.toolMetadata.getSingleToolMetadata
>;
type GetSingleToolMetadataResponse = ServerInferResponses<
  typeof contracts.toolMetadata.getSingleToolMetadata
>;
