...
```
Now, you can include to tool when you create agents with Letta. See a working example [here](https://github.com/cpacker/MemGPT/blob/main/examples/langchain_tool_usage.py).
...
```
Now, you can include the tool to be used with your agent. See a working example [here](https://github.com/cpacker/MemGPT/blob/main/examples/composio_tool_usage.py).
...
```
Now, you can include the tool when you create agents with Letta. See a working example [here](https://github.com/cpacker/MemGPT/blob/main/examples/crewai_tool_usage.py).
