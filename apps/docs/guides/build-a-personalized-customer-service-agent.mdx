...
git clone git@github.com:letta-ai/letta-customer-service-agent-widget-example-starter.git
```
...
Pick "Customer Service" from the given recipes.
...
Back to our sample codebase, copy the `.env.example` file and rename it to `.env`. Replace the placeholders with your Letta API key and source agent key.
```
LETTA_API_KEY=<YOUR_LETTA_API_KEY>
LETTA_SOURCE_AGENT_KEY=<YOUR_LETTA_SOURCE_AGENT_KEY>
```
