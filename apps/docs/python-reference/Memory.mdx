<a id="memgpt.schemas.memory.Memory"></a>
...
<a id="memgpt.schemas.memory.Memory.load"></a>
...
<a id="memgpt.schemas.memory.Memory.compile"></a>
...
<a id="memgpt.schemas.memory.Memory.to_dict"></a>
...
<a id="memgpt.schemas.memory.Memory.to_flat_dict"></a>
...
<a id="memgpt.schemas.memory.Memory.list_block_names"></a>
...
<a id="memgpt.schemas.memory.Memory.get_block"></a>
...
<a id="memgpt.schemas.memory.Memory.link_block"></a>
...
<a id="memgpt.schemas.memory.Memory.update_block_value"></a>

#### update\_block\_value

```python
def update_block_value(name: str, value: Union[List[str], str])
```

Update the value of a block

<a id="memgpt.schemas.memory.BasicBlockMemory"></a>
...
<a id="memgpt.schemas.memory.BasicBlockMemory.__init__"></a>
...
<a id="memgpt.schemas.memory.BasicBlockMemory.core_memory_append"></a>
...
<a id="memgpt.schemas.memory.BasicBlockMemory.core_memory_replace"></a>
...
<a id="memgpt.schemas.memory.ChatMemory"></a>
...
<a id="memgpt.schemas.memory.ChatMemory.__init__"></a>
