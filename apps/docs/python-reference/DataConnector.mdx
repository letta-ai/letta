<a id="memgpt.data_sources.connectors.DataConnector"></a>
...
<a id="memgpt.data_sources.connectors.DataConnector.generate_documents"></a>
...
<a id="memgpt.data_sources.connectors.DataConnector.generate_passages"></a>
