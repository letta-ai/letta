<a id="memgpt.schemas.message.Message"></a>
...
<a id="memgpt.schemas.message.Message.to_memgpt_message"></a>

#### to\_memgpt\_message

```python
def to_memgpt_message(
) -> Union[List[MemGPTMessage], List[LegacyMemGPTMessage]]
```

Convert message object (in DB format) to the style used by the original MemGPT API

<a id="memgpt.schemas.message.Message.dict_to_message"></a>
...
<a id="memgpt.schemas.message.Message.to_openai_dict"></a>

#### to\_openai\_dict

```python
def to_openai_dict(max_tool_id_length: int = TOOL_CALL_ID_MAX_LEN,
                   put_inner_thoughts_in_kwargs: bool = True) -> dict
```

Go from Message class to ChatCompletion message object

<a id="memgpt.schemas.message.Message.to_anthropic_dict"></a>
...
<a id="memgpt.schemas.message.Message.to_google_ai_dict"></a>
...
<a id="memgpt.schemas.message.Message.to_cohere_dict"></a>
