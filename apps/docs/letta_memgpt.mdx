---
sidebarTitle: 'MemGPT concepts'
title: 'MemGPT'
description: 'Learn about the key ideas behind MemGPT'
icon: "book-open"
iconType: "solid"
---

<Tip>The MemGPT open source framework / package was renamed to _Letta_. You can read about the difference between Letta and MemGPT [here](concepts#memgpt), or read more about the change on our [blog post](https://www.letta.com/blog/memgpt-and-letta).</Tip>
