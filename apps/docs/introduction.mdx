...
If you're building an application in Python, you can use the Letta **[Python SDK](http://localhost:3000/python-reference)** to interact with Letta (instead of calling REST APIs directly) for a more seamless experience.
