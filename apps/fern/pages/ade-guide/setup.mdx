...
<Note>
The following instructions are for the cloud/web ADE. If you are using the ADE via [Letta Desktop](/quickstart/desktop), the ADE will automatically open and connect to `localhost:8283` when you run the app.
</Note>
