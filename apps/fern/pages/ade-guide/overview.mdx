...
[Learn more about the Agent Simulator →](/ade-guide/simulator)
...
[Learn more about the Context Window Viewer →](/ade-guide/context-window-viewer)
...
3. [Letta Cloud](/quickstart/cloud)
...
[Learn how to connect the ADE to your server →](/ade-guide/setup)
...
<CardGroup cols={2}>
  <Card title="ADE Setup Guide" icon="rocket" href="/ade-guide/setup">
    Learn how to set up and connect the ADE to your Letta server
  </Card>
  <Card title="Agent Simulator" icon="alien-8bit" href="/ade-guide/simulator">
    Master the agent testing and debugging interface
  </Card>
  <Card title="Tools Management" icon="wrench" href="/ade-guide/tools">
    Create and configure tools to extend your agent's capabilities
  </Card>
  <Card title="Memory Systems" icon="brain" href="/ade-guide/core_memory">
