...
In Letta, you can use **tool variables** to specify the entity ID. Simply set `COMPOSIO_ENTITY` to be your associated entity ID in the **tool variables** section of the ADE (click the **Variables** button in the Agent Simulator):
