---
title: Developer quickstart (Docker)
...
<Note>
View our advanced guide on deploying with Docker [here](/guides/server/docker).
</Note>
...
The recommended way to deploy the Letta Server is with Docker ([view official installation guide](https://docs.docker.com/get-docker)).
...
You can access the ADE at [https://app.letta.com](https://app.letta.com) and connect it to your Docker deployment.
If you would like to use the ADE locally, you can use [Letta Desktop](/quickstart/desktop).
</Note>
...
```json maxLines=50
{
  "messages": [
    ...
    },
    {
      ...
      "content": "Hey! I'm feeling great, thanks for asking! How about you? What’s on your mind?"
    }
  ],
  "usage": {
