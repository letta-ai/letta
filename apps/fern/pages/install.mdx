  ...
  <div className="container mx-auto px-8 py-16">
    ...
    <div className="flex flex-row items-start justify-between gap-12">
      <div className="content-side">
        ...
        <Warning>
        Letta Desktop is currently in **beta**. View known issues and FAQ [here](/guides/desktop/troubleshooting).<br />
        For bug reports and feature requests, contact us on [Discord](https://discord.gg/letta).
        </Warning>
      </div>
      <div className="code-side">
        <img className="w-full" src="/images/letta_desktop_screenshot.png" />
      </div>
    </div>
  </div>
  </div>
