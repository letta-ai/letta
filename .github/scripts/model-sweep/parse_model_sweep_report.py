...
def parse_model_sweep_report(input_file: str, output_file: str, config_file: str = None, compact_output_file: str = None) -> None:
    ...
    for provider_name, provider_info in global_config["providers"].items():
        for model_name, model_config in provider_info["models"].items():
            ...
            base_model_info = {
                ...
                "capabilities": {
                    category: model_config["feature_support"].get(category) == "✅"
                    for category in all_feature_categories
                }
            }
            ...
            detailed_model_info.update({
                "test_results": model_config["test_results"]
            })
...
def main():
    if len(sys.argv) < 2:
        ...
        print("Example: python parse_model_sweep_report.py model_sweep_report.json global_models_config.json config.json global_models_config_compact.json")
        sys.exit(1)
