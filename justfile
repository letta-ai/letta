...
deploy: push
    ...
    helm upgrade --install {{HELM_CHART_NAME}} {{HELM_CHARTS_DIR}}/{{HELM_CHART_NAME}} \
        ...
        --set env.AUTH_GITHUB_CLIENT_ID="${GOOGLE_CLIENT_ID}" \
        --set env.AUTH_GITHUB_CLIENT_SECRET="${GOOGLE_CLIENT_SECRET}" \
        --set env.AUTH_GITHUB_REDIRECT_URI="${GOOGLE_REDIRECT_URI}" \
