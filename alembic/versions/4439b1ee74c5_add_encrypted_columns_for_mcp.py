"""add encrypted columns for mcp

Revision ID: 4439b1ee74c5
Revises: 5d27a719b24d
Create Date: 2025-09-12 16:40:17.440027
...
def upgrade() -> None:
    ...
    print("Run a separate migration later to drop plaintext columns after verification.")
