...
def upgrade() -> None:
    ...
    if is_sqlite():
        with op.batch_alter_table("providers", schema=None) as batch_op:
            batch_op.alter_column("organization_id", existing_type=sa.VARCHAR(), nullable=True)
    else:
...
def downgrade() -> None:
    ...
    if is_sqlite():
        with op.batch_alter_table("providers", schema=None) as batch_op:
            batch_op.alter_column("organization_id", existing_type=sa.VARCHAR(), nullable=False)
    else:
