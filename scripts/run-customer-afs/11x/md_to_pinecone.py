...
def process_markdown_files(
    ...
    upsert_to_pinecone(index_name, vectors, pinecone_api_key, environment, dimension=embedding_dimension)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--directory", type=str, required=True, help="Directory containing markdown files")
    ...
    parser.add_argument("--max-tokens", type=int, default=1000, help="Maximum tokens per chunk (default: 1000)")
    parser.add_argument("--overlap-tokens", type=int, default=50, help="Overlap tokens between chunks (default: 50)")
    parser.add_argument("--environment", type=str, default="us-west1-gcp-free", help="Pinecone environment")
    ...
    parser.add_argument("--force-recreate-index", action="store_true", help="Force recreate the Pinecone index if it exists")
    parser.add_argument("--strict", action="store_true", help="Fail on any error instead of skipping problematic files")
