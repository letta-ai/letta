...
Common labels
*/}}
{{- define "lettuce.labels" -}}
helm.sh/chart: {{ include "lettuce.chart" . }}
{{ include "lettuce.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "lettuce.selectorLabels" -}}
app.kubernetes.io/name: {{ include "lettuce.name" . }}
...
*/}}
{{- define "lettuce.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "lettuce.fullname" .) .Values.serviceAccount.name }}
{{- else }}
