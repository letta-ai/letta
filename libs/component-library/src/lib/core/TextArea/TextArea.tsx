...
const defaultClass =
  'text-base flex min-h-[40px] w-full border border-input bg-background px-3 py-2 pr-[10px] text-text-secondary ring-offset-background placeholder:text-muted-foreground  disabled:cursor-not-allowed disabled:opacity-50';
