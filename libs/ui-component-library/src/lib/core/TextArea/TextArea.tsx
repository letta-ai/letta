...
const defaultClass =
  'text-xs flex min-h-[40px] w-full border border-input bg-panel-input-background px-3 py-2 pr-[10px] ring-offset-background placeholder:text-muted-foreground  disabled:cursor-not-allowed disabled:opacity-90';
