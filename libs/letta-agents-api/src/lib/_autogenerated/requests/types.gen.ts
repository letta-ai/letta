...
export type ChatCompletionRequest = {
    model: string;
    messages: Array<(SystemMessage_Input | UserMessage_Input | AssistantMessage_Input | ToolMessage)>;
...
export type FunctionCallMessage = {
    ...
    function_call: letta__schemas__letta_message__FunctionCall | FunctionCallDelta;
};
...
export type LLMConfig = {
     ...
     * The endpoint type for the model.
     */
    model_endpoint_type: 'openai' | 'anthropic' | 'cohere' | 'google_ai' | 'azure' | 'groq' | 'ollama' | 'webui' | 'webui-legacy' | 'lmstudio' | 'lmstudio-legacy' | 'llamacpp' | 'koboldcpp' | 'vllm' | 'hugging-face' | 'mistral' | 'together';
    /**
 ...
 * The endpoint type for the model.
 */
export type model_endpoint_type = 'openai' | 'anthropic' | 'cohere' | 'google_ai' | 'azure' | 'groq' | 'ollama' | 'webui' | 'webui-legacy' | 'lmstudio' | 'lmstudio-legacy' | 'llamacpp' | 'koboldcpp' | 'vllm' | 'hugging-face' | 'mistral' | 'together';
...
export type LettaResponse = {
    ...
    FunctionCallMessage?: {
        ...
        date: string;
        message_type?: 'function_call';
        function_call: LettaResponse["FunctionCall"] | LettaResponse["FunctionCallDelta"];
    };
    /**
     * A message representing the return value of a function call (generated by Letta executing the requested function).
     *
...
export type MessageRole2 = 'assistant' | 'user' | 'tool' | 'function' | 'system';
...
export type ListAgentInContextMessagesResponse = Array<letta__schemas__message__Message_Output>;
...
export type ListAgentMessagesResponse = Array<letta__schemas__message__Message_Output> | Array<(SystemMessage_Output | UserMessage_Output | InternalMonologue | FunctionCallMessage | FunctionReturn | AssistantMessage_Output)>;
...
export type UpdateAgentMessageResponse = letta__schemas__message__Message_Output;
...
export type UpdateSandboxConfigV1SandboxConfigSandboxConfigIdPatchResponse = SandboxConfig;
...
export type DeleteSandboxConfigV1SandboxConfigSandboxConfigIdDeleteResponse = void;
...
export type CreateSandboxEnvVarV1SandboxConfigSandboxConfigIdEnvironmentVariablePostResponse = SandboxEnvironmentVariable;
...
export type ListSandboxEnvVarsV1SandboxConfigSandboxConfigIdEnvironmentVariableGetResponse = Array<SandboxEnvironmentVariable>;
...
export type UpdateSandboxEnvVarV1SandboxConfigEnvironmentVariableEnvVarIdPatchResponse = SandboxEnvironmentVariable;
...
export type DeleteSandboxEnvVarV1SandboxConfigEnvironmentVariableEnvVarIdDeleteResponse = void;
    ...
    '/v1/agents/{agent_id}/messages': {
        get: {
            ...
            res: {
                 ...
                 * Successful Response
                 */
                200: Array<letta__schemas__message__Message_Output> | Array<(SystemMessage_Output | UserMessage_Output | InternalMonologue | FunctionCallMessage | FunctionReturn | AssistantMessage_Output)>;
                /**
                 * Validation Error
                 */
                422: HTTPValidationError;
