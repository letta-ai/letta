...
export const $AgentState = {
    ...
    additionalProperties: false,
    type: 'object',
    required: ['name', 'tools', 'system', 'agent_type', 'llm_config', 'embedding_config'],
    title: 'AgentState',
...
export const $ContextWindowOverview = {
    ...
    type: 'object',
    required: ['context_window_size_max', 'context_window_size_current', 'num_messages', 'num_archival_memory', 'num_recall_memory', 'num_tokens_external_memory_summary', 'num_tokens_system', 'system_prompt', 'num_tokens_core_memory', 'core_memory', 'num_tokens_summary_memory', 'num_tokens_functions_definitions', 'functions_definitions', 'num_tokens_messages', 'messages'],
...
export const $LLMConfig = {
    properties: {
        ...
        model_endpoint_type: {
            type: 'string',
            enum: ['openai', 'anthropic', 'cohere', 'google_ai', 'azure', 'groq', 'ollama', 'webui', 'webui-legacy', 'lmstudio', 'lmstudio-legacy', 'llamacpp', 'koboldcpp', 'vllm', 'hugging-face', 'mistral', 'together'],
...
export const $OpenAIRun = {
    ...
    type: 'object',
    required: ['id', 'created_at', 'thread_id', 'assistant_id', 'status', 'expires_at', 'model', 'instructions'],
    title: 'OpenAIRun'
} as const;
...
export const $OpenAIRunStep = {
    ...
    type: 'object',
    required: ['id', 'created_at', 'assistant_id', 'thread_id', 'run_id', 'type', 'status', 'step_defaults'],
    title: 'OpenAIRunStep'
} as const;
